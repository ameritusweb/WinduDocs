...
import { insertEitherStrongOrEmphasisTextIntoNormalText, insertStrongTextIntoEmphasisTextOrViceVersa, insertTextIntoEitherACodeBlockOrAlertBlock } from ".";
...
describe('insertStrongTextIntoEmphasisTextOrViceVersa', () => {
    it('updates text and calls history manager correctly', () => {
      ...
      const result = insertStrongTextIntoEmphasisTextOrViceVersa(
        mockContainer, mockChild, editorState, startOffset, mockHistoryManager as IHistoryManager, higherLevelIndex, mockAstParent, containerIndex, mockHigherLevelChildren, mockChildren, 'a');
