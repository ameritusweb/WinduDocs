...
import { enterAroundNormalText, enterAroundQuoteBlocks, enterAroundStrongOrEmphasisText } from ".";
...
describe('enterAroundNormalText', () => {
    it('handles startOffset > 0', () => {
      ...
      const mockUpdateData = {
        ...
        "higherLevelChildren": toMockAstArray([
          {
            "NodeName": "QuoteBlock",
            "Guid": "cb7747a5-e6b2-4240-917c-c6ac59a45b23",
            "Children": [
              {
                "NodeName": "ParagraphBlock",
      ...
      const result = enterAroundNormalText(mockUpdateData, mockHistoryManager, mockChildren, mockContainer, 14);
