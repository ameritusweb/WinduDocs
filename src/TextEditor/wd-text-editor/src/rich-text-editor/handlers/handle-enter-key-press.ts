...
const handleEnterKeyPress = (historyManager: IHistoryManager, container: Node, children: AstNode[], updateData: UpdateData, context: AstContext, range: Range, startOffset: number): AstUpdate | null => {
