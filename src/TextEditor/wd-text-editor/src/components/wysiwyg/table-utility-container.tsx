...
const TableUtilityContainer: React.FC<TableUtilityContainerProps> = ({ show, onAddRow, onAddColumn }) => {
    return (
        <div className={`${show ? 'opacity-100 pointer-events-auto z-[100]' : 'overflow-hidden h-2 opacity-0 pointer-events-none'} absolute top-[0rem] right-[-1rem] p-0 flex flex-col gap-2.5`}>
